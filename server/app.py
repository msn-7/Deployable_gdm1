...
Patient Name: {report_data.get('patient_name', 'Anonymous')}
Risk Level: {result_context.get('risk_level')}
Probability: {result_context.get('probability', 0):.1%}
...
"""
    ...
    success = send_email_notification(patient_email, f"GDM Assessment: {result_context.get('risk_level')}", email_body, pdf_path)
